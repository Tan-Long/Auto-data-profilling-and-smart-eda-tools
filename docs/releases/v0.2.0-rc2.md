...
- Added canonical `table_assessments.json` with one deterministic assessment
  ...
  affected columns, relationship risks, analysis-impact category, evidence
...
- Extended optional LLM summary context and guardrails so table analysis-impact
...
- Redesigned the local web runner as a restrained data-quality console with a
  ...
  issue-review focus, and dedicated table-readiness section.
- Added static UI and Playwright coverage for the new console, table-readiness
