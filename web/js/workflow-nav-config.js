  ...
  profileWorkflowStages: [
    ...
    },
    {
      ...
      substeps: [
        ...
        { target: "reportExport", label: "Report / Export", detail: "Open generated reports" },
    ...
    },
    {
      ...
      number: "05",
      label: "Fix & Recheck",
      detail: "History, corrected upload, staged rerun",
      target: "runHistory",
      substeps: [
        { target: "runHistory", label: "Prior runs", detail: "Open a completed local run" },
        { target: "manualRecheck", label: "Corrected upload", detail: "Upload fixed data or run demo recheck" },
        { target: "remediation", label: "Remediation", detail: "Approve copy-only fixes and recheck" },
      ],
    },
  ],
